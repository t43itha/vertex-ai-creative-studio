...
async def add_global_csp(request: Request, call_next):
    ...
    response.headers["Content-Security-Policy"] = (
        ...
        "img-src 'self' data: blob: https://google-ai-skin-tone-research.imgix.net https://storage.cloud.google.com https://storage.googleapis.com https://*.storage.googleapis.com https://*.googleusercontent.com; "
